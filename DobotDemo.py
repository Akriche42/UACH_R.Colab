from dobot_apiE6 import DobotApiFeedBack,DobotApiDashboard
import threading
...
class DobotDemo:
    ...
    def start(self):
        ...
        if self.parseResultId(self.dashboard.EnableRobot())[0] != 0:
            print("error de habilitado: verificar si el puerto 29999 esta ocupado")
            return
        print("habilitado exitosamente")
        ...
        # 定义两个目标点
        point_a = [78.8526,-67.9921,613.4407,-91.3329,-6.7666,178.0634]
